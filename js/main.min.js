...
/* harmony import */ var _modules_pageStart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/pageStart */ "./js/modules/pageStart.js");
/* harmony import */ var _modules_showMenu__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showMenu */ "./js/modules/showMenu.js");
/* harmony import */ var _modules_showLeftBlock__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showLeftBlock */ "./js/modules/showLeftBlock.js");
...
Object(_modules_pageStart__WEBPACK_IMPORTED_MODULE_3__["pageStart"])('loader');
Object(_modules_showMenu__WEBPACK_IMPORTED_MODULE_4__["showMenu"])('burger-menu', 'nav-menu');
Object(_modules_showLeftBlock__WEBPACK_IMPORTED_MODULE_5__["showLeftBlock"])('main', 'main__wrapper--blue');
...
/***/ "./js/modules/pageStart.js":
/*!*********************************!*\
  !*** ./js/modules/pageStart.js ***!
  \*********************************/
/*! exports provided: pageStart */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageStart", function() { return pageStart; });
var pageStart = function pageStart(selector) {
  var loader = document.querySelector(".".concat(selector));
...
/***/ "./js/modules/showLeftBlock.js":
/*!*************************************!*\
  !*** ./js/modules/showLeftBlock.js ***!
  \*************************************/
/*! exports provided: showLeftBlock */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showLeftBlock", function() { return showLeftBlock; });
var showLeftBlock = function showLeftBlock(selector, target) {
  var button = document.querySelector(".".concat(selector));
  var block = document.querySelector(".".concat(target));
...
var showMenu = function showMenu(selector, target) {
  var button = document.querySelector(".".concat(selector));
  var menu = document.querySelector(".".concat(target));
  var close = "".concat(selector, "--close");
  button.addEventListener('click', function (event) {
    event.preventDefault();
